...
for i1 in A:
    ...
    if rat1<=1:
        nm1 = NearMiss(sampling_strategy=rat1,version=1,random_state=5)
        noclass_train_sampled1,class_train_sampled1  = nm1.fit_sample(noclass_train1, class_train1.values.ravel())
        ...
        for i2 in B:
            ...
            if rat2 <=1:
                nm2 = NearMiss(sampling_strategy=rat2,version=1,random_state=5)
                noclass_train_sampled2,class_train_sampled2  =nm2.fit_sample(noclass_train2, class_train2.values.ravel())
