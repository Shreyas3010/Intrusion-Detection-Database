...
data_train.loc[data_train['xAttack']=='normal', 'Class'] = 2
...
for i1 in A:
    ...
    if rat1<=1:
        rus1=RandomUnderSampler(sampling_strategy=rat1,random_state=5,replacement=True)
        noclass_train_sampled1,class_train_sampled1  =rus1.fit_sample(noclass_train1, class_train1.values.ravel())
        #noclass_train_sampled1,class_train_sampled1  = rus1.fit_sample(noclass_train1, class_train1.values.ravel())
        ...
        data_train2.loc[data_train2['xAttack']==1, 'Class'] = 0
        data_train2.loc[data_train2['xAttack']==2, 'Class'] = 1
        ...
        for i2 in B:
            ...
            if rat2 <=1:
                rus2=RandomUnderSampler(sampling_strategy=rat2,random_state=5,replacement=True)
                noclass_train_sampled2,class_train_sampled2  =rus2.fit_sample(noclass_train2, class_train2.values.ravel())
